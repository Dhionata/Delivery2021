...
public class testeFornecedor {
    public static void main(String[] args) {
        ...
        Fornecedor fornecedor = new Fornecedor(1, "TesteLTDA", "Empresa de teste", "000.000.000-00");

        EnderecoFornecedor enderecoFornecedor = new EnderecoFornecedor(2, fornecedor, "Anhanguera", "Goiânia",
                "Cerrado", "Q.0, L.0", "0000000-00", "S/N", 0.000000F, 0.000000F);
        ...
        // quantidadeEmEstoque)
        fornecedor.adicionarProduto(new ProdutoFornecedor(new Produto(5, "Mamão"), fornecedor, 0.15f, 3));
